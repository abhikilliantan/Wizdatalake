...
1. Architecture — [http://localhost:8020/architecture.html](http://localhost:8020/architecture.html)
2. API (execute live) — [http://localhost:8000/docs](http://localhost:8000/docs)
3. Audit feed — [http://localhost:8000/v1/catalog/recent?limit=12](http://localhost:8000/v1/catalog/recent?limit=12)
4. Object store — [http://localhost:9007](http://localhost:9007) (`minioadmin` / `minioadmin`) → `datalake-raw`
