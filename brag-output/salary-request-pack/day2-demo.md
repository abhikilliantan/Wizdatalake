...
2. [http://localhost:8000/v1/catalog/recent?limit=12](http://localhost:8000/v1/catalog/recent?limit=12)
3. [http://localhost:9007](http://localhost:9007) → bucket `datalake-raw` (`minioadmin` / `minioadmin`)
...
**OpenAPI:** [http://localhost:8000/docs](http://localhost:8000/docs) → tag **serve**
