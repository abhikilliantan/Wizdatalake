...
- Catalog: [http://localhost:8000/v1/catalog/recent?limit=12](http://localhost:8000/v1/catalog/recent?limit=12)  
- MinIO: [http://localhost:9007](http://localhost:9007) (default local: `minioadmin` / `minioadmin`) → bucket `datalake-raw`
...
| Artifact                  | Location                                                                                                     |
| ------------------------- | ------------------------------------------------------------------------------------------------------------ |
| Julius PR (origin)        | [https://github.com/JuliusMutugu/DataLakeSkM/pull/46](https://github.com/JuliusMutugu/DataLakeSkM/pull/46)   |
| Abhishek / Wizdatalake PR | [https://github.com/abhikilliantan/Wizdatalake/pull/1](https://github.com/abhikilliantan/Wizdatalake/pull/1) |
